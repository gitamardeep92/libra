...
function WhatsAppSettings({ flash, saving, setSaving }) {
  ...
  return (
    <div className="card" style={{maxWidth:520}}>
      ...
      {/* Only show form fields when not configured or in edit mode */}
      {showForm && (<>
        <div className="form-group">
    ...
    <div>
          ...
          :subs.map(s=>{
            ...
            return(<tr key={s.id}>
              ...
              <td><div className="flex gap-2">
                ...
                {!exp&&<button className="btn btn-danger btn-sm" onClick={()=>{setShowModal(false);setCancelConfirm(s);}}>Cancel</button>}
              </div></td>
            </tr>);
          })}
      </tbody></table></div></div>
      ...
      {showModal&&<div className="modal-overlay"><div className="modal modal-lg">
        ...
        <div className="modal-body">
          ...
          {/* Cancel Confirmation Modal moved outside showModal */}
